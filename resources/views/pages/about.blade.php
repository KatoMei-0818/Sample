...
@section('content')
    ...
    <div class="rounded bg-white mb-3 p-5 shadow fs-5">
        ...
        <div class="px-2 mb-4">
            <h4>管理者ページ</h4>
            Laravel-adminを使用した管理者用のページです。<br>
            現在はユーザーの追加、編集、削除ができます。
        </div>
    ...
    <div class="rounded bg-white mb-3 p-5 shadow fs-5">
        <h3>投稿について</h3>
        ダッシュボード画面から新しい投稿を作成することができます。<br>
        自分の投稿が表示されるページから自分の投稿にアクセスしたときのみ、その投稿の編集や削除が行えます。<br><br>
        「タイトル」と「本文」は必須項目となっています。<br>
        特に「タイトル」は3文字以上でなければいけません。<br>
        「公開日」はデフォルトでは今日の日付が指定してありますが、変更することができます。<br>
        「タグ」はタグ一覧に登録してあるタグから好きなだけつけることができ、タグをつけないこともできます。
        
    </div>

    <div class="rounded bg-white mb-3 p-5 shadow fs-5">
        <h3>アピールポイント</h3>
        なるべく画面の比率が変わっても表示が崩れないようにしています。<br>
        背景をグラデーションにしています。<br>
        投稿やタグ、アカウントの削除ボタンを押すと確認のモーダルが表示されます。<br>
        投稿を閲覧する際、本文の文字を大きくしています。<br>
        自分の投稿が表示されるページ以外から投稿にアクセスすると、その投稿者のユーザーページにアクセスできるボタンが表示されます。<br>
