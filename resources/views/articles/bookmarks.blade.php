        ...
        <div class="row">
            <div class="col">
                <h5 class="text-center px-2 py-1 position-relative">
                    <a href="{{ url('dashboard') }}" class="text-muted text-decoration-none stretched-link">     
                        自分の投稿
                    </a>
                </h5>
            </div>
            <div class="col border-top-coral bg-white">
                <h5 class="text-center py-2 position-relative">
                    <a href="{{ url('bookmarks') }}" class="text-dark text-decoration-none stretched-link">
                        お気に入り
                    </a>
                </h5>
            </div>
